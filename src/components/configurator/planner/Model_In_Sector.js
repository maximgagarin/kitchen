...
export class Model_In_Sector {
  ...
  //  this.createControls()
   ...
   createLines(){
        this.lineHotizontal = new Line(this.sceneSetup,{x:-(this.objectSize.x)/2, y:0.9, z:-(this.objectSize.x)/2}, 
                                   {x:-(this.objectSize.x)/2, y:0.9, z:(this.objectSize.x)/2})
 ...
 //   helper.userData.controller = this;
    ...
    this.raycasterBox.userData.id = this.id
    if(this.box){
     // console.log('root')
