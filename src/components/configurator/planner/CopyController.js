...
export class CopyController {
  ...
  checkSimpleCollision(testInstance) {
    ...
    const pos =
      side == "left" ? testInstance.position.z : testInstance.position.x;
    ...
    let modelsArray =
      side == "left" ? plannerConfig.modelsLeft : plannerConfig.modelsDirect;
    ...
    for (let model of modelsArray) {
      ...
      const modelPos =
        side == "left" ? model.root.position.z : model.root.position.x;
